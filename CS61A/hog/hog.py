...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if gain > previous_high:
            ...
            next_score,next_high = score,gain

        return announce_highest(who, gain,next_high)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    # a complex solution to retrive the key of the max value in a dictionary.
    # from operator import itemgetter
    # return max({num_rolls:make_averaged(roll_dice, num_samples)(num_rolls, dice) for num_rolls in range(1,11)}.iteritems(),
    #            key=itemgetter(1))[0]
    score_dict = {make_averaged(roll_dice, num_samples)(num_rolls, dice):num_rolls for num_rolls in range(1, 11)}
    return score_dict.get(max(score_dict.keys()))
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # if score < 10 and score < opponent_score:
    #     return bacon_strategy(score, opponent_score, margin=8, num_rolls=4)
    # elif score < opponent_score:
    #     return 0
    # else:
    # return
    return bacon_strategy(score, opponent_score, margin=8, num_rolls=4) or swap_strategy(score, opponent_score, margin=1, num_rolls=10)
        # END PROBLEM 12
